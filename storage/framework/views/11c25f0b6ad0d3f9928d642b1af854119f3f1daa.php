                        ...
                        <div class="hero_section">
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-sm-5">
                                    <img src="<?php echo e(asset('assets/img/' . $page->images)); ?>" class="zoomIn wow animated" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="inner_wrapper">
                    <div class="container">
                        ...
                        <div class="inner_section">
                            <div class="row">
                                <div class=" col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-right"><img src="<?php echo e(asset('assets/img/' . $page->images)); ?>" class="img-circle delay-03s animated wow zoomIn" alt=""></div>
            ...
            <div class="team_section clearfix">
                ...
                <div class="team_area">
                    <div class="team_box wow fadeInDown delay-0<?php echo e(($k*3 +1)); ?>s">
                        ...
                        <img src="<?php echo e(asset('assets/img/' . $people->images)); ?>" alt="">
                        <ul>
