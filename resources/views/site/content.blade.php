                ...
                <div class="team_area">
                    <div class="team_box wow fadeInDown delay-0{{ ($k*3 +1) }}s">
                        ...
                        <ul>
                            ...
                            <li><a href="{{ $people->url }}" class="fa fa-pinterest"></a></li>
                            <li><a href="{{ $people->url }}" class="fa fa-google-plus"></a></li>
                        </ul>
                    </div>
                    <h3 class="wow fadeInDown delay-0{{ ($k*3 +1) }}s">{{ $people->name }}</h3>
                    <span class="wow fadeInDown delay-0{{ ($k*3 +1) }}s">{{ $people->position }}</span>
                    <p class="wow fadeInDown delay-0{{ ($k*3 +1) }}s">{{ $people->text }}</p>
                </div>
                @endforeach
            </div>
        </div>
